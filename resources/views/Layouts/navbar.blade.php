        ...
        <div class="flex justify-between items-center h-16">
            <div class="flex items-center">
                <div class="flex-shrink-0 flex items-center">
                    <img src="{{ asset('storage/' . ($setting->logo ?? 'images/logo-tikecs.png')) }}" alt="Logo Tikecs" class="h-12 w-auto" />
                    <h1 class="text-2xl font-bold text-gray-900 ml-2">{{ $setting->nama_website }}</h1>
                </div>
            </div>
                    ...
                    <div class="relative">
                        ...
                        <div id="userDropdown" class="hidden absolute right-0 mt-2 w-48 bg-white rounded-xl shadow-xl border border-gray-100 z-50 overflow-hidden">
                            <div class="py-1">
                                ...
                                <a href="{{ route('admin.settings.index') }}" class="block px-4 py-3 text-sm text-gray-700 hover:bg-indigo-50 transition">Settings</a>
