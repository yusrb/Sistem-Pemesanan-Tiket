        ...
        <form action="{{ route('penumpang.update', $penumpang) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" name="nama" id="nama" value="{{ old('nama', $penumpang->nama) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
                ...
                <div>
                    ...
                    <input type="text" name="nik" id="nik" value="{{ old('nik', $penumpang->nik) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (form) {
            form.addEventListener('submit', () => {
                showNotification('Memperbarui penumpang', 'info');
            });
        }
