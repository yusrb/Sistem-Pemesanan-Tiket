...
@section('judul', 'Edit User - Manajemen Tiket Kereta')
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-gray-600">Perbarui data user, <span class="font-semibold">{{ now()->format('d F Y') }}</span></p>
            </div>
    ...
    document.addEventListener('DOMContentLoaded', () => {
        ...
        if (form) {
            form.addEventListener('submit', () => {
                showNotification('Memperbarui user', 'info');
            });
        }
