...
@section('judul', 'Edit Jadwal - Manajemen Tiket Kereta')
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-gray-600">Perbarui jadwal, <span class="font-semibold">{{ now()->format('d F Y') }}</span></p>
            </div>
        ...
        <form action="{{ route('admin.jadwal.update', $jadwal) }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <select name="kereta_id" id="kereta_id" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
                        ...
                        @foreach ($keretas as $kereta)
                            <option value="{{ $kereta->id }}" {{ $jadwal->kereta_id == $kereta->id ? 'selected' : '' }}>{{ $kereta->nama }}</option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="text" name="stasiun_awal" id="stasiun_awal" value="{{ old('stasiun_awal', $jadwal->stasiun_awal) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
                ...
                <div>
                    ...
                    <input type="text" name="stasiun_akhir" id="stasiun_akhir" value="{{ old('stasiun_akhir', $jadwal->stasiun_akhir) }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga', $jadwal->harga) }}" min="0" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
