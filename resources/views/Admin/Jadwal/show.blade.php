...
@section('judul', 'Detail Jadwal - Manajemen Tiket Kereta')
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-gray-600">Informasi jadwal, <span class="font-semibold">{{ now()->format('d F Y') }}</span></p>
            </div>
    ...
    <div class="bg-white rounded-xl p-6 shadow-lg hover:bg-gray-50 transition">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
                ...
                <p class="text-lg text-gray-900">{{ $jadwal->kereta->nama }}</p>
            </div>
            <div>
                <p class="text-sm font-semibold text-gray-600">Stasiun Awal</p>
                <p class="text-lg text-gray-900">{{ $jadwal->stasiun_awal }}</p>
            </div>
            <div>
                <p class="text-sm font-semibold text-gray-600">Stasiun Akhir</p>
            ...
            <div>
                <p class="text-sm font-semibold text-gray-600">Jam Sampai</p>
                <p class="text-lg text-gray-900">{{ $jadwal->jam_sampai }}</p>
            </div>
            <div>
                <p class="text-sm font-semibold text-gray-600">Harga</p>
                <p class="text-lg text-gray-900">Rp {{ number_format($jadwal->harga, 0, ',', '.') }}</p>
            </div>
        </div>
