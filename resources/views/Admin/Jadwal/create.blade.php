    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="text-gray-600">Tambahkan jadwal baru, <span class="font-semibold">{{ now()->format('d F Y') }}</span></p>
            </div>
        ...
        <form action="{{ route('jadwal.store') }}" method="POST">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="date" name="tanggal" id="tanggal" value="{{ old('tanggal') }}" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
                ...
                <div>
                    ...
                    <input type="number" name="harga" id="harga" value="{{ old('harga') }}" min="0" class="w-full border border-gray-200 rounded-lg px-4 py-2 focus:outline-none focus:border-indigo-500">
